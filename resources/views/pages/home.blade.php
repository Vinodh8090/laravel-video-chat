...
@section('content')
    ...
    <!-- <div class="container">
        <div class="text-center mb-4">
            <h2 class="font-weight-bold">Featured Models</h2>
            <p>Explore our featured models</p>
        </div>
        <div class="row">
        @foreach($modelProfiles as $model)
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="{{ $model->profile_pic }}" class="card-img-top" alt="{{ $model->name }}">
                <div class="card-body">
                    <h5 class="card-title">{{ $model->name }}</h5>
                    <p class="card-text">{{ $model->country }}, {{ $model->city }}</p>
